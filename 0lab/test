...
echo "... exercise --catch --dump-core --segfault option"
./$PGM --catch --dump-core --segfault 2>STDERR
testRC $? $SIG_SEGFAULT
...
echo
echo "THE STUDENT WHO WILL RECEIVE CREDIT FOR THIS SUBMISSION IS:"
echo "    $ID    $EMAIL"
echo
